...
namespace Magento\CatalogGraphQlTests\GraphQl;
...
class CategoryTest extends GraphQlAbstract
{
    ...
    /**
     * @magentoApiDataFixture Magento_CustomerTests::fixture/customer.php
     * @magentoApiDataFixture Magento_CatalogTests::fixture/categories.php
